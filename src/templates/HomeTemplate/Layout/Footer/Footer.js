...
export default function Footer() {
  return (
    <footer className="py-6 dark:bg-coolGray-800 dark:text-coolGray-50 bg-gray-600 text-white">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                <svg
                  ...
                  viewBox="0 0 32 32"
                  fill="currentColor"
                  className="flex-shrink-0 w-5 h-5 rounded-full dark:text-coolGray-900 text-white"
                >
